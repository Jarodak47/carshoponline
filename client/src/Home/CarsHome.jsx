                            ...
                            <div className="col-md-12 col-lg-3 mb-3 mb-lg-0 my-3">
                                <div className="card">
                                    ...
                                    <Link to={`/car/${p.slug}`} className='text-center'>
                                        <img src={p.productPictures} alt={p.model} style={{ maxWidth: '100%', maxHeight: '130px', objectFit: 'contain' }} className='border rounded' />
                                    </Link>
                                    <div className="card-body ">
                                        <h4 className="text-center mb-4 respName">{p.model}</h4>
                                        <div className="d-flex justify-content-between">
                                            <h6 className='respBrand'><PiCurrencyInrFill /> : {p.price} $</h6>
